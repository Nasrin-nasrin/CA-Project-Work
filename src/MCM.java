...
// stores the minimum number of scalar multiplications (i.e., cost)needed to compute matrix `M[i+1] … M[j] = M[i…j]`
        int min = Integer.MAX_VALUE;
 
// take the minimum over each possible position at which the sequence of matrices can be split
