...
{  
// A utility method, which returns the maximum of two integers a1 and a2  
...
if (j == 0 || wt == 0){  
    ...
    // similar the previous approach making two choices either exluding or including the items  
